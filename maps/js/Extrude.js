...
window.onload = function () {
    ...
    polygonDataSource.then(function (polygonDataSource) {
        ...
        var promise2002 = Cesium.loadJson('../data/themes/2002.json');
...
function updateOnePolygon(polygon, thematicData) {
    "use strict";
    var data = thematicData[polygon.properties.id];     // id is the ISO3166-2 country code
...
function yearChange() {
    ...
    // load thematic data (from JSON file)
    var promiseData = Cesium.loadJson('../data/themes/' + currentYear + '.json');
    
    // update polygon properties according to thematic data
